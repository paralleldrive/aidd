---
name: aidd-autodux
description: Create and transpile Autodux Redux state management dux objects. Use when building Redux state management, defining reducers, action creators, or selectors.
---
...
Autodux {
  ...
  /example - Example SudoLang source code in [Autodux example](../aidd-redux-example/SKILL.md)
