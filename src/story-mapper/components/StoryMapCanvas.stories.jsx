            ...
            createStep({
              ...
              stories: [
                createStory({
                  name: "Add journey",
                  description:
                    "As a PM, I want to add journeys to organize work",
                  priority: "high",
                  points: 5,
                }),
                createStory({
            ...
            createStep({
              ...
              stories: [
                createStory({
                  ...
                  description:
                    "As a PM, I want to click to edit journeys/steps/stories",
                  priority: "high",
                  points: 8,
                }),
                createStory({
            ...
            createStep({
              ...
              stories: [
                ...
                createStory({
                  name: "Refine with AI",
                  description:
                    "As a PM, I want to refine stories using natural language",
                  priority: "high",
                  points: 8,
                }),
              ],
            ...
            createStep({
              ...
              stories: [
                createStory({
                  ...
                  description:
                    "As a PM, I want to accept/reject AI suggestions",
                  priority: "medium",
                  points: 5,
                }),
              ],
