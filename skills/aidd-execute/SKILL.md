---
name: aidd-execute
description: Implement tasks using Test-Driven Development. Use when implementing features, fixing bugs, or writing code. Follows red-green-refactor cycle with strict test-first discipline.
aiddCommands: [/execute]
globs: "**/*.js,**/*.jsx,**/*.ts,**/*.tsx"
---
...
- UI testing strategy:
  ...
  - Side effects: must be isolated from UI, see @ai/rules/javascript/javascript-io-network-effects.mdc
