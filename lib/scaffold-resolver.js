...
// @ts-expect-error -- repoUrl is always a string
...
/**
 * @param {{uri: string, scaffoldDownloadDir?: string, download: Function, existsFn?: Function}} options
 */
const downloadExtension = async ({
  ...
  if (await existsFn(scaffoldDownloadDir)) {
    throw createError({
      ...ScaffoldDestinationError,
      message: `Scaffold download destination already exists: ${scaffoldDownloadDir}. Run \`npx aidd scaffold-cleanup\` to remove it before downloading again.`,
    });
  }
...
/**
 * @param {{effectiveType: string, packageRoot: string, scaffoldDownloadDir: string, download: Function, resolveRelease: Function, confirm: Function, existsFn?: Function}} options
 */
 ...
 * @param {{ type?: string, packageRoot?: string, scaffoldDownloadDir?: string, confirm?: Function, download?: Function, resolveRelease?: Function, existsFn?: Function, log?: Function, readConfigFn?: Function }} [options]
