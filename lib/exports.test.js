...
describe("README.md skill links", () => {
  test("links /aidd-requirements to the correct renamed path", async () => {
    ...
    assert({
      given: "README.md skills table after aidd-functional-requirements rename",
      should:
        "not contain broken link to old aidd-functional-requirements path",
      actual: readme.includes(
        "ai/skills/aidd-functional-requirements/README.md",
      ),
      expected: false,
    });
    ...
    assert({
      given: "README.md skills table after aidd-functional-requirements rename",
      should:
        "link /aidd-requirements to ai/skills/aidd-requirements/README.md",
      actual: readme.includes("ai/skills/aidd-requirements/README.md"),
      expected: true,
    });
  });
});
