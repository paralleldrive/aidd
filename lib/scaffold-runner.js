...
/** @param {string | string[]} commandOrArgs @param {string} cwd */
...
/** @param {{ manifestPath: string, extensionJsPath?: string, folder: string, agent?: string, execStep?: typeof defaultExecStep }} options */
