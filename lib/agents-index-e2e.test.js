...
`,
  ...
  test("--index generates index.md files", async () => {
    ...
    const skillsIndexExists = await fs.pathExists(
      path.join(aiPath, "skills", "index.md"),
    );
    ...
    assert({
      given: "--index command",
      should: "create ai/skills/index.md",
      actual: skillsIndexExists,
      expected: true,
    });
  ...
  test("generated index includes file descriptions from frontmatter", async () => {
    ...
    assert({
      given: "generated skills index",
      should: "include file description from frontmatter",
      actual: skillsIndex.includes("Test skill for integration testing"),
      expected: true,
    });
  });
  ...
  test("generated index links to subdirectories", async () => {
    ...
    assert({
      ...
      should: "link to skills subdirectory",
      actual: aiIndex.includes("skills/index.md"),
      expected: true,
    });
