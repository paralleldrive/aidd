 ...
 *
 * @param {{ type?: string, folder?: string, agent?: string, packageRoot?: string, resolveExtensionFn?: Function, runManifestFn?: Function, ensureDirFn?: Function }} [options]
 */
const runCreate = async ({
  ...
  const paths = await resolveExtensionFn({
    ...
    scaffoldDownloadDir: path.join(folder, ".aidd", "scaffold"),
    type,
  });
