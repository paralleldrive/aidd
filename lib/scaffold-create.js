...
import { scaffoldCleanup as defaultScaffoldCleanup } from "./scaffold-cleanup.js";
 ...
 *
 * @param {{ type?: string, folder: string, agent?: string, packageRoot?: string, resolveExtensionFn?: Function, runManifestFn?: Function, ensureDirFn?: Function, copyFn?: Function, existsFn?: Function, scaffoldCleanupFn?: Function }} options
 */
const runCreate = async ({
  ...
  scaffoldCleanupFn = defaultScaffoldCleanup,
}) => {
  if (await existsFn(folder)) {
    throw createError({
