...
const DIRECTIVE_APPEND_SECTIONS = [
  {
 ...
 * Each section in DIRECTIVE_APPEND_SECTIONS is included only when at least one
...
const appendDirectives = async (
  ...
  const sections = DIRECTIVE_APPEND_SECTIONS.filter(({ keywords }) =>
