 ...
 * - Not present → create with full agentsMdContent.
 * - Present and already has all required directives → leave unchanged.
 * - Present and already references AGENTS.md → leave unchanged.
 * - Present but incomplete → append a short pointer to AGENTS.md.
 */
const ensureClaudeMd = async (targetBase) => {
  ...
  // Treat the file as complete when it already contains the full agent
  // directives (e.g. created by a previous install) OR when it explicitly
  // links to AGENTS.md.
  if (
