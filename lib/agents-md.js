...
const requiredDirectives = [
  ...
  "import aidd-custom/AGENTS.md", // Import override from aidd-custom
  "Task Index", // Task index for common agent operations
];
...
and read \`aidd-custom/config.yml\` to load configuration into context.`,
  ...
  {
    content: `import aidd-custom/AGENTS.md // settings from this import should override the root AGENTS.md settings`,
    keywords: ["import aidd-custom/AGENTS.md"],
  },
  {
    content: `## Task Index
