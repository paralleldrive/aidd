...
`;
  ...
  describe("appendDirectives", () => {
    test("does not add a second wrapper heading when called twice", async () => {
      ...
      await appendDirectives(tempDir, initialContent, [...REQUIRED_DIRECTIVES]);
  ...
  describe("REQUIRED_DIRECTIVES", () => {
    test("contains the expected directive keywords", () => {
      ...
      assert({
        ...
        actual: REQUIRED_DIRECTIVES.includes("aidd-custom"),
        expected: true,
      });
    });
  });

  describe("DIRECTIVE_APPEND_SECTIONS", () => {
    test("exports an array of section objects with content and keywords", () => {
      assert({
        given: "DIRECTIVE_APPEND_SECTIONS constant",
        should: "be an array",
        actual: Array.isArray(DIRECTIVE_APPEND_SECTIONS),
        expected: true,
      });
      ...
      assert({
        ...
        actual: DIRECTIVE_APPEND_SECTIONS.every(
          (s) =>
