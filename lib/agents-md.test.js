...
`;
  ...
  describe("ensureClaudeMd", () => {
    test("creates CLAUDE.md with agent guidelines content when no CLAUDE.md exists", async () => {
      ...
      assert({
        ...
        should: "contain the standard agent guidelines content",
        actual: content,
        expected: agentsMdContent,
      });
    });

    test("returns unchanged when CLAUDE.md was created by a previous install", async () => {
      // Simulate the second install: CLAUDE.md was created by the first install
      // with agentsMdContent, which has no literal "AGENTS.md" substring.
      ...
      assert({
        ...
        should: "return unchanged action without modifying the file",
        actual: result.action,
        expected: "unchanged",
      });
    ...
    test("returns unchanged when CLAUDE.md explicitly references AGENTS.md", async () => {
    ...
    test("appends AGENTS.md pointer when CLAUDE.md exists without agent directives", async () => {
      ...
      assert({
        given:
          "an existing CLAUDE.md without agent directives or AGENTS.md reference",
        should: "return appended action",
        actual: result.action,
        expected: "appended",
      });
